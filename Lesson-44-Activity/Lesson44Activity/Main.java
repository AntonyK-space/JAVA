...
class Main {
 ...
 public static void main(String[] args)throws IOException{
  ...
  void init() {
    ...
    sql = "Select Name , Title From tracks"
    ...
    sql0 = "Select FirstName, LastName, InvoiceID, InvoiceDate From invoices"
    sql0 += "Where InvoiceDate = '2012-04-__';"
    result0 = db.runSQL(sql0, "table-auto");
    print(result0);
